<div class="tab-pane fade " id="v-pills-stripe" role="tabpanel" aria-labelledby="v-pills-stripe-tab" tabindex="0">
    ...
    <form action="{{ route('stripe.post',['success_url'=> 'parent.student_fee_success_payment','cancle_url' => 'parent.student_fee_fail_payment','payment_method'=>'stripe']) }}" method="post" class="paypal-form form">
        @csrf
